...
Глобальной балансировки между датацентрами нет, поэтому DNS-схема сводится к маршрутизации балансировщик L4 и CDN-доменов для статики и медиа.
...
#### L7: расчёт количества узлов по данным трафика
