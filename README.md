...
Источник выгрузки: файл в репозитории `Лист Microsoft Excel.xlsx`. [[11]](./%D0%9B%D0%B8%D1%81%D1%82%20Microsoft%20Excel.xlsx)

| Показатель | Значение |
|---|---:|
| Кол-во поисковых фраз в выгрузке | 1 880 |
| Суммарная частота запросов за сутки (выгрузка) Q_sample | 10 805 232 |
| Суммарные просмотры карточек за сутки (выгрузка) V_sample | 10 959 425 |
| Суммарные контакты за сутки (выгрузка) C_sample | 196 471 |
...
`S_user,i = N_user,i * S_i` (с переводом: 1 ГБ = 1024 МБ, 1 МБ = 1024 КБ, 1 КБ = 1024 Б)
...
Формула хранения:  
`S_total,i = N_i * S_i` (с переводом: 1 ТБ = 1024 ГБ, 1 ГБ = 1024 МБ, 1 МБ = 1024 КБ, 1 КБ = 1024 Б)
...
11. Выгрузка данных по поисковым запросам за 17.02.2026 (файл `Лист Microsoft Excel.xlsx` в репозитории)
